...
public class Bishop extends Piece{
	...
	private final static int[] CANDIDATE_MOVE_COORDINATES_LINE = {-1, 1};
	private final static int[] CANDIDATE_MOVE_COORDINATES_COLUMN = {-1, 1};
	
	public Bishop(Alliance allience) {
		super("Bishop", allience);
